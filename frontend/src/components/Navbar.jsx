...
const Navbar = () => {
  ...
  const logoutHandler = async () => {
    try {
      const res = await axios.get("https://gmail-clone-xwwi.onrender.com/api/v1/user/logout", {
    ...
    <div className="flex items-center justify-between mx-3 h-16">
      <div className="flex items-center gap-10">
        <div className="flex items-center gap-2">
          ...
          <img
            className="w-8"
            src="https://cdn.iconscout.com/icon/free/png-512/free-gmail-2981844-2476484.png?f=webp&w=256"
            alt=""
          />
          <h1 className="text-2xl text-gray-400 font-medium">Gmail</h1>
        </div>
      </div>
      {user && (
        <>
          ...
          <div className="flex items-center gap-2">
            <div className="p-3 rounded-full hover:bg-gray-200 cursor-pointer">
              <HiOutlineQuestionMarkCircle size={"24px"} />
            </div>
            <div className="p-3 rounded-full hover:bg-gray-200 cursor-pointer">
